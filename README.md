...
Nocturne is a cinematic, dependency-free interactive experience built for the modern web. Visitors move through a generative star field, awaken five memory stars, and reveal an original poem one line at a time.

## Features

- Responsive animated canvas with cursor parallax and particle effects
- Five-part constellation discovery experience
